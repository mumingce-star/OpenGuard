...
def test_openapi_preserves_business_routes_with_additive_history_diff_and_graph_get(harness: ApiHarness) -> None:
    ...
    assert response.json()["paths"] == {
        ...
        "/api/v1/scans/{scan_id}/resource-profiles/refresh": {"post": response.json()["paths"]["/api/v1/scans/{scan_id}/resource-profiles/refresh"]["post"]},
        "/api/v1/scans/{scan_id}/resource-profiles/jobs/{job_id}": {"get": response.json()["paths"]["/api/v1/scans/{scan_id}/resource-profiles/jobs/{job_id}"]["get"]},
        ...
        "/api/v1/scans/{scan_id}/assessments/{assessment_id}/notice-drafts": {"post": response.json()["paths"]["/api/v1/scans/{scan_id}/assessments/{assessment_id}/notice-drafts"]["post"]},
        "/api/v1/scans/{scan_id}/assessments/{assessment_id}/notice-drafts/{draft_id}": {"get": response.json()["paths"]["/api/v1/scans/{scan_id}/assessments/{assessment_id}/notice-drafts/{draft_id}"]["get"]},
