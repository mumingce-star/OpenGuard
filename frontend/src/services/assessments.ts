...
export type Assessment = { review_view?: ReviewView; id: string; version: number; scan_id: string; formal?: boolean; project_name: string; generated_at: string; usage: Usage; summary: string; ai_status: string; ai_summary: string | null; ai_evidence_ids?: string[]; dimensions: Dimension[]; coverage_issues: string[]; resource_ids: string[]; finding_ids: string[]; evidence_ids: string[]; rule_version: string; model_version: string; prompt_version: string; facts_hash: string; resource_evaluations?: { resource_id: string; name: string; finding_ids: string[]; evidence_ids: string[] }[]; obligations: { id: string; action: string; requirement: string; trigger: string; fulfillment: string; resource_ids: string[]; evidence_ids: string[]; rule_id: string; rule_version: string }[] };
